...
COINRUNCMD="sudo dotnet ./x42.x42D.dll ${NETWORK} -agentprefix=trustaking -datadir=/home/${NODE_USER}/.${FORK}node -maxblkmem=2 -txindex=1 #-stake -walletname=\${STAKINGNAME} -walletpassword=\${STAKINGPASSWORD}"
