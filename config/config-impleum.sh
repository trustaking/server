...
COINRUNCMD="sudo dotnet ./Impleum.ImpleumD.dll ${NETWORK} -agentprefix=trustaking -datadir=/home/${NODE_USER}/.${FORK}node -maxblkmem=2 -txindex=1 \${stakeparams} \${rpcparams} "
