...
NETWORK=""
NODE_USER=impleum${NETWORK}
COINCORE=/home/${NODE_USER}/.impleumnode/impleum/ImpleumMain
COINPORT=16271
COINRPCPORT=16172
COINAPIPORT=38222
DNSPORT=53
...
NETWORK="-testnet"
NODE_USER=impleum${NETWORK}
COINCORE=/home/${NODE_USER}/.impleumnode/impleum/ImpleumTest
COINPORT=16271
COINRPCPORT=16272
COINAPIPORT=39222
DNSPORT=53
...
COINRUNCMD="sudo dotnet ./impleum.impleumFullNodeD.dll ${NETWORK} -datadir=/home/${NODE_USER}/.impleumnode -iprangefiltering=0 ${DNS}"  ## additional commands can be used here e.g. -testnet or -stake=1
CONF=release
COINGITHUB=https://github.com/impleum/ImpleumBitcoinFullNode.git
COINDAEMON=impleumd
COINCONFIG=impleum.conf
COINSTARTUP=/home/${NODE_USER}/impleumd
COINDLOC=/home/${NODE_USER}/impleumNode
