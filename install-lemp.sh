#!/bin/bash
# =================== YOUR DATA ========================
#bash <( curl -s https://raw.githubusercontent.com/trustaking/server/master/install-lamp.sh )
...
#apt-get install -y php-sqlite3 php-memcached php7.0-mcrypt php-imagick php7.0-bcmath php7.0-intl php7.0-readline
...
##TODO: update /etc/php/7.0/cli/php.ini >> remove the ; from intl
